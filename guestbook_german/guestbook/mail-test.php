...
$dsmsg = "". $_SERVER['HTTP_REFERER'] ."";
 ...
 $msg .= "$dsmsg";
   ...
   $msg = strip_tags ($msg);
$ihrname = "no-reply@yellabook.de";
$ihrname2 = "no-reply@yellabook.de";
	$dsubject = "Test erfolgreich!"; 
...
$dmsg  = "Wenn Sie diese E-Mail lesen können, wurde die PHP Mail Funktion erfolgreich auf Ihrem Server getestet.\n\n";
   $dmsg .= "Sie können nun die Datei mail-test.php löschen und das Gästebuch YellaBook nutzen. ";
...
echo "Das Formular wurde erfolgreich versandt. Sie sollten innerhalb der nächsten Sekunden eine E-Mail erhalten.";
...
<p><b>Formular zum Testen der PHP Mailfunktion auf Ihrem Server</b><br /><p>Bitte Ihre <b>E-Mail Adresse</b> eintragen und auf <b>Senden</b> klicken.<br /><br />Innerhalb weniger Sekunden sollten Sie eine E-Mail erhalten. <br />Diese Datei kann danach gel&ouml;scht werden.</p>
...
<fieldset class="kontaktdaten">
    <legend>TEST - PHP Mail Funktion</legend>
	<table>
		<tr>
